        ...
        $(function () {
            ...
            $("#registerForm").submit(function () {
                ...
                if (
                    ...
                    $.post("userRegisterServlet", $(this).serialize(), function (data) {
            ...
            <form id="registerForm" action="user">
                ...
                <table style="margin-top: 25px;">
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" id="username" name="LOGIN_NAME" " placeholder="请输入用户名">
                        </td>
                    </tr>
                    <tr>
                        <td class="td_left">
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" id="name" name="realName"  placeholder="请输入真实姓名">
                        </td>
                    </tr>
                    <tr>
                        <td class="td_left">
...
<%--                    </tr>--%>
                    <tr>
                        ...
                        <td class="td_right check">
                            <input type="text" id="check" name="verifycode" class="check">
