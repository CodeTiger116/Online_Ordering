...
<div class="container-fluid">
    <div class="row" style="width: 100%;position: absolute;top:50px;bottom: 0;left: 0;">
        <div class="col-xs-2" style="height:100%;background: dodgerblue;">
            <ul class="nav nav-pills nav-stacked guide" id="guideBar">
